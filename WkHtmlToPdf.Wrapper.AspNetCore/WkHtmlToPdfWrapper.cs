...
{
    public class WkHtmlToPdfWrapper : IDisposable
    {
        ...
        private readonly ILogger<WkHtmlToPdfWrapper> _logger;
        ...
        internal WkHtmlToPdfWrapper(ILogger<WkHtmlToPdfWrapper> logger,  string wkHtmlExePath) : this(wkHtmlExePath)
        {
            _logger = logger;
        }
        ...
        private void Log(object sender, ConversionOutputEvent ev)
        {
            _logger?.Log(ev.EventType.ToLogLevel(), ev.Message);
        }
